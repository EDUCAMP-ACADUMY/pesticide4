...
const products = [
  ...
  },
  {
    ...
    price: 899,
    image: "https://images.unsplash.com/photo-1600615084980-e7132c46cdb2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
  }
];
...
const Shop = () => {
  const handleWhatsApp = (productName: string) => {
    ...
    window.open(`https://wa.me/918968691133?text=${encodeURIComponent(message)}`, '_blank');
  };
